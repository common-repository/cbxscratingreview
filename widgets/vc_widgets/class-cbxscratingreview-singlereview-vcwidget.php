<?php
	 ...
	 *
	 * Class CBXSCRatingReviewSingleReview_VCWidget
	 */
	class CBXSCRatingReviewSingleReview_VCWidget extends WPBakeryShortCode {
		/**
		 * Constructor.
		 */
		...
		public function bakery_shortcode_mapping() {
			...
			vc_map( array(
				"name"        => esc_html__( "Individual Review Display", 'cbxscratingreview' ),
				"description" => esc_html__( "Individual Review Display Widget Settings", 'cbxscratingreview' ),
				"base"        => "cbxscratingreview_singlereview",
	...
	}// end class CBXSCRatingReviewSingleReview_VCWidget
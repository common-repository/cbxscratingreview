<?php
	...
	/**
	 * CBX 5 Star Rating & Review - Individual Review Display Elementor Widget
	 */
	class CBXSCRatingReviewSingleReview_ElemWidget extends \Elementor\Widget_Base {
		...
		public function get_name() {
			return 'cbxscratingreviewsinglereview';
		}
		...
		public function get_title() {
			return esc_html__( 'Individual Review Display', 'cbxscratingreview' );
		}
		...
		public function get_icon() {
			return 'cbxscratingreview-singlereview-icon';
		}
		...
		protected function _register_controls() {
			...
			$this->start_controls_section(
				'section_cbxscratingreview_singlereview',
				array(
					'label' => esc_html__( 'Individual Review Widget Settings', 'cbxscratingreview' ),
				)
			);
		...
		protected function render() {
			...
			$attr = apply_filters( 'cbxscratingreview_elementor_shortcode_builder_attr', $attr, $settings, 'singlereview' );
			...
			echo do_shortcode( '[cbxscratingreview_singlereview ' . $attr_html . ']' );
		}//end render
	...
	}//end class CBXSCRatingReviewSingleReview_ElemWidget

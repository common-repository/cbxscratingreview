<?php
	...
	/**
	 * CBX 5 Star Rating & Review - Latest Ratings Elementor Widget
	 */
	class CBXSCRatingReviewLRating_ElemWidget extends \Elementor\Widget_Base {
		...
		public function get_name() {
			return 'cbxscratingreviewlrating';
		}
		...
		public function get_title() {
			return esc_html__( 'Latest Ratings', 'cbxscratingreview' );
		}
		...
		public function get_icon() {
			return 'cbxscratingreview-lratings-icon';
		}
		...
		protected function _register_controls() {
			...
			$this->start_controls_section(
				'section_cbxscratingreview_lratings',
				array(
					'label' => esc_html__( 'Latest Ratings Widget Settings', 'cbxscratingreview' ),
				)
			);
			...
			$this->add_control(
				...
				array(
					...
					'default'     => esc_html__( 'Latest Ratings', 'cbxscratingreview' ),
				)
			);
		...
		protected function render() {
			...
			$attr = apply_filters( 'cbxscratingreview_elementor_shortcode_builder_attr', $attr, $settings, 'cbxscratingreviewlratings' );
			...
			echo do_shortcode( '[cbxscratingreviewlratings ' . $attr_html . ']' );
		}//end render
